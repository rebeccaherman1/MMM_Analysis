...
All observations and model output can be found in the [data](/data) folder, sorted by variable and then by season. Variables used for this analaysis include [pr](/data/pr/7-9) and [ts](/data/ts/7-9) over the West African Monsoon Season, JAS. All variables are seasonally averaged and area-averaged over the Sahel or some other ocean basin. 
