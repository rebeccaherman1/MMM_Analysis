...
for i = 1:length(scenarios)
    ...
    for v = 1:length(variables)
        ...
        prcp_smth = smooth(smooth(prcp_anomaly, 20),5)';
        prcp_smth_s = prcp_smth./std(prcp_smth, 0,2);
	...
	GA = load(make_analysis_filename(variable,scenario, start_year, end_year, 500));
        ...
        MMM_smth_s = MMM_smth/std(MMM_smth, 0, 2);
        ...
        GM_smth_s = GM_smth./std(GM_smth, 0, 2);
	...
	I = load(make_data_filename(variable, start_month, end_month, scenario,'all'));
        ...
        runs_smth_s = runs_smth./std(runs_smth, 0, 2);
    end
        ...
        for dx = 1:Indx
            ...
            plot(ref_T_years,GM_smth_s(:,:,dx), 'Color', mdgnd, 'LineStyle', '-', 'LineWidth', 1, 'HandleVisibility', 'off');
            ...
            p_gm_s = plot(ref_T_years,GM_smth(:,:,dx), '-', 'Color', mdgnd, 'LineWidth', 1);
